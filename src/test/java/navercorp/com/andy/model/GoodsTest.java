...
class GoodsTest {
    ...
    public void testGoods() {
        ...
        goods.add(new Goods("-1", "라오스 다이어리","신동","1594645127700",2000,0,5, "/img/goods/001_1.jpg", "디지털/가전", "안녕", Long.valueOf(0)));
        goods.add(new Goods("1", "자이글","권선동","1594645127642",20000,0,0, "/img/goods/002_1.jpg", "디지털/가전", "하세요", Long.valueOf(1)));
        goods.add(new Goods("2", "라오스 다이어리","신동","1594645127700",2000,0,5, "/img/goods/001_1.jpg", "디지털/가전", "여기", Long.valueOf(2)));
        goods.add(new Goods("3", "삼성 파워건 VS80M8090KC 싸게 팔아요","수원시 팔달구 인계동","1594645127622",270000,1,3, "/img/goods/003_1.jpg", "디지털/가전", "들어가는 내용은", Long.valueOf(0)));
    ...
    public void testGoodsListItem() {
        Goods good = new Goods("0", "라오스 다이어리","신동","1594645127700",2000,0,5, "/img/goods/001_1.jpg", "디지털/가전", "안녕", Long.valueOf(0));
