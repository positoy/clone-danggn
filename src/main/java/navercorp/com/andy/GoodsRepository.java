...
public class GoodsRepository {
    ...
    public GoodsRepository() {
        goods = new ArrayList<>();
        goods.add(new Goods("0", "라오스 다이어리","신동","1594645127",2000,0,5, "/img/001_1.jpg", "디지털/가전", "안녕", "0"));
        goods.add(new Goods("1", "자이글","권선동","1594645127",20000,0,0, "/img/002_1.jpg", "디지털/가전", "하세요", "1"));
